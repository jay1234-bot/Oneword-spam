...
async def _callbacks(Badmunda: Client, callback_query: CallbackQuery):
    ...
    elif query == "oneword_help1":
        await callback_query.answer(oneword_help1, show_alert=True)
    elif query == "oneword_help2":
        await callback_query.answer(oneword_help2, show_alert=True)
